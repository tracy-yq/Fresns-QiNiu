...
function progressReset() {
    ...
    $('.ajax-progress-submit span').remove();
    $('.ajax-progress-submit').prop('disabled', false);
    $('.ajax-progress-submit').text('确认上传');
}
...
function progressDown() {
    ...
    $('.ajax-progress-submit').text('上传完成');
}
...
function progressExit() {
    ...
    $('.ajax-progress-submit span').remove();
    $('.ajax-progress-submit').prop('disabled', true);
    $('.ajax-progress-submit').text('上传失败');
}
